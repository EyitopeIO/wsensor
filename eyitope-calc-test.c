...
UNIT_TEST_REGISTER(test_equals_window_size, "Test when exactly window size");
UNIT_TEST_REGISTER(test_above_window_size, "Test input above window size");

static float avg = 0.0f;
static float cfm[] = {5.0f, 5.5f, 6.0f, 6.5f, 7.0f, 7.5f, 8.0f, 9.0};   // Expected results
static float tst[] = {5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f};   // test cases
...
UNIT_TEST(test_below_window_size)
{
    ...
    UNIT_TEST_ASSERT(avg == cfm[2]);    // cfm[2] is the 3rd element
